...
function funcGetLeftDownload() {
    $.ajax({
        type: "get",
        dataType: "json",
        url: '123.57.26.127/api/Download/GetDownloadList?pageIndex=1&pageSize=20&dmTypeValue=政策法规下载',
        data: {},
...
function funcGetRightDownload() {
    $.ajax({
        type: "get",
        dataType: "json",
        url: '123.57.26.127/api/Download/GetDownloadList?pageIndex=1&pageSize=20&dmTypeValue=HR表格下载',
        data: {},
        success: function (data) {
